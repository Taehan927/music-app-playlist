      ...
      <div style={styles.card}>
        <div style={styles.brandRow}>
          ...
          <div>
            ...
            <div style={styles.brandTagline}>Save. Organize. Play.</div>
          </div>
        </div>

        <div style={styles.header}>
          <h1 style={styles.title}>Create your account</h1>
          <p style={styles.subtitle}>Start building playlists from YouTube</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          {message && (
            <div
              style={{
                ...styles.alert,
                borderColor: message.toLowerCase().includes("account created")
                  ? "#10b981"
                  : "#ef4444",
              }}
            >
...
// same style object as Login (keeps both pages consistent)
const styles = {
  page: {
    minHeight: "100vh",
    display: "flex",
